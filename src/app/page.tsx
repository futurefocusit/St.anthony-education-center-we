...
const Home = () => {
  ...
  <img 
    ...
    alt="" 
    className='lg:relative lg:left-[600px] lg:w-[620px] md:max-w-xl max-w-full mx-6 lg:mx-0 h-[500px] object-cover'
  />
  
  <div className='lg:absolute lg:left-[61px] lg:top-[2840px] flex flex-col bg-[#D9D9D9] max-w-full md:max-w-xl p-3 mx-6 mb-6'>
...
<p className='w-full max-w-[625px] h-auto font-[800] text-[28px] sm:text-[36px] text-[#1ABC9C] text-center m-auto'>
...
<div className='bg-[#D9D9D9] max-w-[500px] w-full h-auto sm:h-[400px] p-4 sm:p-8 mx-auto flex flex-col items-center'>
  ...
  <div className='w-full max-w-[454px] bg-white p-4 space-y-4'>
    {/** Rating Bar Rows */}
    {[
      ...
      <div key={index} className='flex items-center justify-between'>
        <p className='w-[60px]'>{rating.label}</p>
...
<div className='flex card-holder  justify-center items-center gap-6 w-full md:w-[600px] lg:w-[1000px] m-auto'>
  ...
  <div className='flex flex-col justify-center' key={index}>
    ...
    <div className='flex flex-row gap-6 lg:gap-40'>
      ...
      <div className="flex flex-col justify-center items-center text-center md:text-left m-auto">
        <h1 className="font-[800] text-teal-500 text-[24px] sm:text-[28px] md:text-[36px]">WHAT'S NEW?</h1>
