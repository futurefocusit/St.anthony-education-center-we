...
<section
        className=' h-auto relative -top-36  pt-32 pb-32 leading-10 -mb-32 lg:pl-[50px]  pl-[5px] '
        style={{
      ...
      >
       <div className=" h-auto pb-3 pt-16  ">
        <h2 className="text-[#1B396E] pt-10 pl-10 text-6xl">
      ...
      <div className="w-[100%] h-full bg-[#ffffff]  px-20 pb-2  max-md:px-5 mt-0 mx-auto ">
        <div>
          <h1 className="text-[#1B396E] font-merriweather text-10px text-2xl ml-[11.5em] max-md:ml-0  py-3">
            Professional Camera Installation
          </h1>
          <p className="text-[#1B396E] font-merriweather pb-3 text-sm ml-[19.5em] max-md:ml-0  ">
        ...
        <section>
        <div className=" py-7 ">
            <h1 className="text-[#1B396E] font-merriweather  text-2xl pb-3">
        ...
        <section className="flex flex-row gap-5 max-sm:flex-col mt-0 ">
          ...
          <div>
            ...
            <p className="pt-2 font-roboto">
            earn from industry professionals with years of experience in
