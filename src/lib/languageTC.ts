export const translations = {
    en: {
      ...
      welcome: "Welcome to the CyberPro Group Terms of Use agreement.",
      siteDefinition:
        'For purposes of this agreement, "Site" refers to the Company\'s website, which can be accessed at www.cyberprogroup.com.',
      serviceDefinition:
        '"Service" refers to the Company\'s services accessed via the Site, in which users can access our services of Cyberpro Academy (cybersecurity training), Cybersecurity Consulting, and CCTV Camera Security Solutions.',
      termsDefinition:
        'The terms "we," "us," and "our" refer to the Company. "You" refers to you, as a user of our Site or our Service.',
      applicability:
        "The following Terms of Use apply when you view or use the Service via our website located at www.cyberprogroup.com",
      reviewRequest:
    ...
    fr: {
      ...
      siteDefinition:
        'Aux fins du présent accord, "Site" fait référence au site Web de la Société, accessible à l\'adresse www.cyberprogroup.com.',
      serviceDefinition:
        '"Service" fait référence aux services de la Société accessibles via le Site, dans lesquels les utilisateurs peuvent accéder à nos services de Cyberpro Academy (formation en cybersécurité), de conseil en cybersécurité et de solutions de sécurité par caméras de vidéosurveillance.',
      termsDefinition:
        'Les termes "nous", "notre" et "nos" font référence à la Société. "Vous" fait référence à vous, en tant qu\'utilisateur de notre Site ou de notre Service.',
      applicability:
        "Les conditions d'utilisation suivantes s'appliquent lorsque vous consultez ou utilisez le Service via notre site Web situé à l'adresse www.cyberprogroup.com",
      reviewRequest:
        "Veuillez lire attentivement les conditions suivantes. En accédant au Service ou en l'utilisant, vous signifiez votre accord avec ces Conditions d'utilisation. Si vous n'acceptez pas d'être lié par l'intégralité de ces Conditions d'utilisation, vous ne pouvez pas accéder au Service ni l'utiliser.",
      ...
      registration:
        "Inscription ; Règles de conduite de l'utilisateur et d'utilisation du Service",
      registrationText:
      ...
      useRestrictions: "Restrictions d'utilisation",
      useRestrictionsText:
